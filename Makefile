...
install :; forge install cyfrin/foundry-devops@0.3.2 --no-commit && forge install foundry-rs/forge-std@v1.9.6 --no-commit && forge install openzeppelin/openzeppelin-contracts@v5.3.0 --no-commit
